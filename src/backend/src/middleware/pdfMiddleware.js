...
const createPDF = async (reportType, patientFirst, patientLast, carerFirst, carerLast,  shiftNotes) => {
    const doc = new PDFDocument();
    doc
      .font("Helvetica")
      .text(`Client: ${patientFirst} ${patientLast}`);
    doc
      .font("Helvetica")
      .text(`Carer: ${carerFirst} ${carerLast}`);
    doc
      .font("Helvetica")
